...
def send_deletion_success_task(to):
    ...
    try:
        ...
        mail.send(to=to, subject="Your DevAgentic Account Has Been Successfully Deleted", html=html_content)
...
def send_account_deletion_verification_code(to, code):
    ...
    try:
        ...
        mail.send(to=to, subject="DevAgentic Account Deletion and Verification", html=html_content)
