const translation = {
  ...
  corePlan: {
    title: 'Core Capabilities Plan',
    description: 'Unlock advanced features and capabilities for your team',
    feature1: 'Advanced AI model access',
    feature2: 'Priority support and faster processing',
    feature3: 'Enhanced team collaboration features',
  },
  upgradeToCore: 'Upgrade to Core',
  upgrading: 'Processing...',
  manageSubscription: 'Manage Subscription',
  openingPortal: 'Opening Portal...',
  accessDenied: 'Only team owners and admins can access billing settings.',
  stripeNotConfigured: 'Stripe billing is not configured. Please contact your administrator.',
  checkoutError: 'Failed to create checkout session. Please try again.',
  portalError: 'Failed to open customer portal. Please try again.',
  plansCommon: {
