        ...
        <div className='flex flex-col items-center gap-4 py-8'>
          {systemFeatures.branding.enabled && systemFeatures.branding.workspace_logo
            ? <img
              ...
              alt='logo'
            />
            : <DevAgenticLogo size='large' className='mx-auto' />}
          ...
          <div className='flex flex-col items-center gap-2 text-center text-xs font-normal text-text-secondary'>
            ...
            <div className='text-text-accent'>
              {
                IS_CE_EDITION
                  ? <Link href={'https://github.com/devagentic/devagentic/blob/main/LICENSE'} target='_blank' rel='noopener noreferrer'>Open Source License</Link>
                  : <>
                    <Link href='https://devagentic.io/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,&nbsp;
                    <Link href='https://devagentic.io/terms' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center'>
            <Button className='mr-2' size='small'>
              <Link
                href={'https://github.com/devagentic/devagentic/releases'}
